...
export default function FeedbackPage() {
  ...
  const [feedbackMode, setFeedbackMode] = React.useState<"form" | "audio">("form")
  ...
  React.useEffect(() => {
    ...
    speak("Welcome to the feedback page. Please share your experience with AccessSubmit.", assistantVoice)
  }, [])
  ...
  const startRecording = async () => {
    try {
      ...
      const assistantVoice = getOppositeGenderVoice(userGender)
      speak("Unable to access microphone. Please check your permissions.", assistantVoice)
    }
  }
  ...
  const stopRecording = () => {
    if (mediaRecorderRef.current && isRecording) {
      ...
      const assistantVoice = getOppositeGenderVoice(userGender)
      speak("Recording stopped. Your audio feedback has been captured.", assistantVoice)
    }
  }
  ...
  const handleFormFocus = () => {
    if (isRecording) {
      stopRecording()
      const assistantVoice = getOppositeGenderVoice(userGender)
      speak("Audio recording paused. You can now fill the form.", assistantVoice)
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const assistantVoice = getOppositeGenderVoice(userGender)
    speak("Submitting your feedback. Thank you for helping us improve AccessSubmit.", assistantVoice)

    // Mock submission
    setTimeout(() => {
      setIsSubmitted(true)
      speak("Your feedback has been submitted successfully. We appreciate your input.", assistantVoice)
    }, 1500)
  }
      ...
      <div className="container max-w-2xl mx-auto px-4 py-16 md:py-24">
        <Card className="border-2 shadow-xl">
          <CardContent className="pt-16 pb-16 flex flex-col items-center gap-6">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-center">Thank You!</h2>
            <p className="text-lg text-muted-foreground text-center max-w-md">
              Your feedback has been recorded. Your insights help us build a more accessible platform for everyone.
            </p>
    ...
    <div className="container max-w-3xl mx-auto px-4 py-12 md:py-20">
      <div className="space-y-6 mb-12">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed">
          Your experience matters. Help us improve AccessSubmit by sharing your thoughts via audio recording or the form
          below.
        </p>
      </div>
      ...
      <Card className="border-2 shadow-xl">
        <CardHeader>
          <CardTitle className="text-2xl md:text-3xl font-bold">Feedback Form</CardTitle>
          <CardDescription className="text-base">
            All fields except disability type are optional. Your feedback is anonymous and encrypted.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4 p-6 rounded-2xl bg-secondary/20 border-2">
              ...
              <p className="text-sm text-muted-foreground">
                Record your feedback using your voice. Recording will automatically pause if you start typing in the
                form.
              </p>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Label htmlFor="disability" className="text-lg font-semibold">
                  Type of Disability <span className="text-muted-foreground font-normal">(Optional)</span>
                </Label>
                <Select value={disabilityType} onValueChange={setDisabilityType}>
                  <SelectTrigger id="disability" className="h-14 text-lg" onFocus={handleFormFocus}>
                    <SelectValue placeholder="Select if applicable" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="visual">Visual Impairment</SelectItem>
                    <SelectItem value="hearing">Hearing Impairment</SelectItem>
                    <SelectItem value="motor">Motor/Physical Disability</SelectItem>
            ...
            <Button
              ...
              disabled={!name && !email && !feedback && !isRecording}
            >
